 ...
 */
final class Version20210205191440 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE restaurant ADD accepted TINYINT(1) NOT NULL, CHANGE gallery gallery LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE restau_description restau_description VARCHAR(255) NOT NULL, CHANGE rate rate INT NOT NULL, CHANGE restau_image restau_image VARCHAR(255) NOT NULL');
